...
class FtpCommonClass
{
    ...
    {
        $config = array(
            'hostname' => 'toword-na.ingest.cdn.level3.net',
            'username' => 'toword',
            'password' => 'TariqLaguna',
        );
    ...
    function mkdir($path = '', $permissions = NULL)
    {
        ...
        $result = @ftp_mkdir($this->conn_id, './f/c/d');
    ...
    public function dir_path($path){
        return @ftp_size($this->conn_id,$path.'lock.txt');
    }
    /**
     * 上传一个文件到服务器
     *
    ...
    function upload($locpath, $rempath, $mode = 'auto', $permissions = NULL)
    {
        ...
        $result = @ftp_put($this->conn_id, $rempath, $locpath, FTP_BINARY);
