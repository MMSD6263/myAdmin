$(function() {
    ...
    var a = echarts.init(document.getElementById("echarts-scatter-chart"));
    var j = {
        title: {
            text: "男性女性身高体重分布",
        ...
        series: [{
            ...
            tooltip: {
                ...
                formatter: function(w) {
                    if (w.value.length > 1) {
                        return w.seriesName + " :<br/>" + w.value[0] + "cm " + w.value[1] + "kg "
                    } else {
                        return w.seriesName + " :<br/>" + w.name + " : " + w.value + "kg "
                    }
                }
            },
    ...
    var u = echarts.init(document.getElementById("echarts-k-chart"));
    var l = {
        title: {
            text: "2013年上半年上证指数"
        },
        tooltip: {
            ...
            formatter: function(x) {
                var w = x[0].seriesName + " " + x[0].name;
                w += "<br/>  开盘 : " + x[0].value[0] + "  最高 : " + x[0].value[3];
                w += "<br/>  收盘 : " + x[0].value[1] + "  最低 : " + x[0].value[2];
                return w
            }
        },
        legend: {
    ...
    var r = echarts.init(document.getElementById("echarts-radar-chart"));
    var d = {
        title: {
            text: "预算 vs 开销",
            subtext: "纯属虚构"
    ...
    var c = echarts.init(document.getElementById("echarts-chord-chart"));
    var b = {
        title: {
            text: "测试数据",
            subtext: "From d3.js",
    ...
    var s = echarts.init(document.getElementById("echarts-force-chart"));
    var f = {
        title: {
            text: "人物关系：乔布斯",
            subtext: "数据来自人立方",
    ...
    var p = echarts.init(document.getElementById("echarts-gauge-chart"));
    var n = {
        tooltip: {
            formatter: "{a} <br/>{c} {b}"
        },
    ...
    var t = echarts.init(document.getElementById("echarts-funnel-chart"));
    var g = {
        title: {
            text: "漏斗图",
            subtext: "纯属虚构"
